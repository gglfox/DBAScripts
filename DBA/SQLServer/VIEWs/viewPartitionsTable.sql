...
USE DWH
DECLARE @tableName NVARCHAR(200) = N'dbo.FACClientesResumen_new'
SELECT
	...
	CASE f.boundary_value_on_right WHEN 1 THEN 'less than'  ELSE 'less than or equal to' END as comparison,
	rv.value,
